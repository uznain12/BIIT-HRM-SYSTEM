...
class AllPostedJobsDetail extends StatefulWidget {
  int? uid;
  int? jid;
  AllPostedJobsDetail({super.key, required this.uid, required this.jid});
  // const ApplicantApplyJob({super.key});

  @override
  State<AllPostedJobsDetail> createState() => _AllPostedJobsDetailState();
}

class _AllPostedJobsDetailState extends State<AllPostedJobsDetail> {
  List<JobGetModel> jobdetaillist = [];
  late Widget _widget;
  @override
  void initState() {
    super.initState();
    _widget = AllPostedJobsDetail(
      uid: widget.uid,
      jid: widget.jid,
    );
  }
