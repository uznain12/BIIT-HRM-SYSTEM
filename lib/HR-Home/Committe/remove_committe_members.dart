...
class RemoveCommitteMember extends StatefulWidget {
  int? uid;
  ...
  @override
  State<RemoveCommitteMember> createState() => _RemoveCommitteMemberState();
}

class _RemoveCommitteMemberState extends State<RemoveCommitteMember> {
  List<LoginModel> userlist = [];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Remove From Committe"),
          centerTitle: true,
        ),
        body: FutureBuilder(
            future: fetchcuser(),
      ...
      if (response.statusCode == 200) {
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Success'),
              content: Text('User Remove From committee successfully.'),
              actions: <Widget>[
                TextButton(
                  child: Text('OK'),
                  onPressed: () {
