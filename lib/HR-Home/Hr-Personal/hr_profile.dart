...
class HrPersonalInfo extends StatefulWidget {
  int? uid;
  HrPersonalInfo({super.key, required this.uid});

  @override
  State<HrPersonalInfo> createState() => _HrPersonalInfoState();
}

class _HrPersonalInfoState extends State<HrPersonalInfo> {
